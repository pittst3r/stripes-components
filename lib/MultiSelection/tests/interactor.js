...
const optionListClass = selectorFromClassnameString(`.${css.multiSelectOptionList}`);
const togglebuttonClass = selectorFromClassnameString(`.${css.multiSelectToggleButton}`);
...
export default interactor(class MultiSelectInteractor {
  ...
  optionListStyle = attribute(optionListClass, 'style');
  menuStyle = attribute(menuClass, 'style');
  ...
  clickToggleButton = clickable(togglebuttonClass);
