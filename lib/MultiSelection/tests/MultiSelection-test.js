...
describe.skip('MultiSelect on small screen', () => {
  const smallmultiselection = new MultiSelectionInteractor();
  ...
  it('renders the control', () => {
    expect(smallmultiselection.controlPresent).to.be.true;
  });

  describe('clicking the control', () => {
    beforeEach(async () => {
      await smallmultiselection.clickControl();
    });

    it('opens the list', () => {
      expect(smallmultiselection.listHiddenAttributeSet).to.be.false;
    });

    it('focuses the filter input', () => {
      expect(smallmultiselection.filterIsFocused).to.be.true;
    });

    describe('clicking the toggleButton with the open menu', () => {
      beforeEach(async () => {
        await smallmultiselection.clickToggleButton();
      });

      it('closes the list', () => {
        expect(smallmultiselection.listHiddenAttributeSet).to.be.true;
      });

      it('focuses the control input', () => {
        expect(smallmultiselection.controlIsFocused).to.be.true;
      });
    });
  });
});
