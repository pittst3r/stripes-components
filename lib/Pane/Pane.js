...
class Pane extends React.Component {
  constructor(props) {
    ...
    if ('noOverflow' in this.props) {
      console.warn('[DEPRECATION] The noOverflow prop of <Pane> is deprecated. Use overflow prop instead.');
    }
  }
  ...
  getContentClass() {
    const { overflow: overflowType } = this.props;
